...
public class LoginWithInvalidCredentials extends SharedDataUI {
    ...
    public void verifyLoginWithInvalidCredentials() {
        System.out.println("Step 2: Login with invalid credentials");

        ExtentUtility.attachReportLog(ReportStep.INFO_STEP, "Login with invalid credentials");
        ...
        ExtentUtility.attachReportLog(ReportStep.PASS_STEP, "User not able to logged in with invalid credentials. Correct Error Message displayed");
