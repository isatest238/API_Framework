...
public class LoginWithLockedUserName extends SharedDataUI {
    ...
    public void verifyLoginWithLockedUsername() {
        ExtentUtility.attachReportLog(ReportStep.INFO_STEP, "Start Test: Login with locked username");
        ...
        ExtentUtility.attachReportLog(ReportStep.INFO_STEP, "Credentials inserted. Trying to login with locked user");
        LoggerUtility.infoTest("Credentials inserted. Trying to login with locked user");
        ...
        ExtentUtility.attachReportLog(ReportStep.PASS_STEP, "User cannot login with locked username. Correct error message displayed");
        LoggerUtility.infoTest("User cannot login with locked username. Correct error message displayed");
    }
}
